  ...
  return (
    <div className="carousel w-full">
      <div id="slide1" className="carousel-item h-[600px] relative w-full">
        ...
        <div
          className="absolute 
      h-full bg-gradient-to-r flex rounded-lg items-center from-[#151515] to-[rgba(21, 21, 21, ,0)] "
        >
          <div className="text-white pl-12 space-y-7 w-1/2">
            <h2 className="text-6xl font-bold mr-5">
            ...
            <div>
              ...
              <button className="text-white ml-4 btn btn-outline">
                Latest Project
              </button>
            </div>
          </div>
